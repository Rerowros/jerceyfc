...
<Callout type="info" title="Course Navigation: Part 2">
  You are reading part 2 of the "Networking 2025" course.

1. [How the Internet Works: From Cables to HTTPS](/en/blog/network-fundamentals/)
2. [**TSPU Deep Dive (You are here)**](/en/blog/tspu-deep-dive/)
