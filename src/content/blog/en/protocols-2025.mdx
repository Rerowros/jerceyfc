...
<Callout type="info" title="Course Navigation: Part 3">

  You are reading part 3 of the "Networking 2025" course.

  1. [How the Internet Works: From Cables to HTTPS](/en/blog/network-fundamentals/)
  2. [TSPU Deep Dive](/en/blog/tspu-deep-dive/)
  3. [**Network Protocol Architecture 2025 (You are here)**](/en/blog/protocols-2025/)
